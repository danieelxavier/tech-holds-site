...
<!--                </div>-->
                        ...
                        <div class="create-notice-form mb50 wow fadeIn">
                            ...
                            <form action="#" id="create-notice-form" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group" id="body-field">
                                    <div class="form-input">
                                        <label for="form-body">Email:</label>
                                ...
                                <div class="form-group" id="body-field">
                                    <div class="form-input">
                                        <label for="form-body">Confirm password:</label>
                                        <input type="password" class="form-control" id="form-confirm-password" name="form-confirm-password" placeholder="Confirm password.." required>
                                    </div>
                                </div>
    ...
    <script type="text/javascript">
        ...
        var processNewUser = function (data){
            // console.log(data);
            $.ajax({
                type: "POST",
                url: "../../php/create-user-process.php",
                data: data,
                dataType:'JSON',
